...
function websdkready() {
  ...
  var API_KEY = "LiY7zQAlSDupd5RC3W3ofQ";
   ...
   */
  var API_SECRET = "wyftpzSbDqBu3ag0WEFtMG2M1zxJHtApDCHR";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "C:/Users/Administrator/Desktop/sample-app-web-master/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "C:/Users/Administrator/Desktop/sample-app-web-master/CDN/meeting.html?" +
